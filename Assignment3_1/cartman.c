...
*/
void reserve2(unsigned int c, enum junction junc, enum junction junc2);
void release2(unsigned int c, enum junction junc, enum junction junc2);
void *cart_start(void * a);
